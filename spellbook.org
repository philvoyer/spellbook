...
d^
** delete line to begin from point
d0x
** character swap next
xp
...
** select around line
val
** select around sentence
vas
** select around paragraph
vap
** select around symbol
vao
** select around string
va'
** select around parenthesis
vab
...
** send to repl (region)
, s r
** send to repl (function)
, s f
** send to repl (last sexp)
, s e
* chapter 10 - latex
** set master file
C-c _
